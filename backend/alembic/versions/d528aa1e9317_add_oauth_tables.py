...
Revision ID: d528aa1e9317
Revises: a93b088988d2
Create Date: 2025-11-02 07:54:16.896310
...
revision: str = 'd528aa1e9317'
down_revision: Union[str, Sequence[str], None] = 'a93b088988d2'
...
def upgrade() -> None:
    ...
    sa.Column('policy_uri', sa.String(length=500), nullable=True),
    sa.Column('tos_uri', sa.String(length=500), nullable=True),
